...
// Source: ./sanity/lib/banners/getBannerBySlug.ts
// Variable: BANNER_BY_SLUG_QUERY
// Query: *[                _type == "banner"                && slug.current == $bannerSlug            ]
export type BANNER_BY_SLUG_QUERYResult = Array<{
  _id: string;
  _type: "banner";
  _createdAt: string;
  _updatedAt: string;
